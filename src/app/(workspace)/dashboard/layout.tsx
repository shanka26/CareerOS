    ...
    <div className="min-h-screen">
      <header className="border-b border-[var(--line)] bg-[var(--paper)]/85 px-5 py-3 backdrop-blur sm:px-8">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
          ...
          <nav className="hidden items-center gap-1 md:flex" aria-label="Workspace"><Link href="/dashboard" className="rounded-full px-3 py-2 text-sm font-semibold text-[var(--muted)] hover:bg-white">Home</Link><Link href="/dashboard/career" className="rounded-full px-3 py-2 text-sm font-semibold text-[var(--muted)] hover:bg-white">Career</Link><Link href="/dashboard/jobs" className="rounded-full px-3 py-2 text-sm font-semibold text-[var(--muted)] hover:bg-white">Jobs</Link><Link href="/dashboard/documents" className="rounded-full px-3 py-2 text-sm font-semibold text-[var(--muted)] hover:bg-white">Documents</Link><Link href="/dashboard/applications" className="rounded-full px-3 py-2 text-sm font-semibold text-[var(--muted)] hover:bg-white">Applications</Link><Link href="/dashboard/analytics" className="rounded-full px-3 py-2 text-sm font-semibold text-[var(--muted)] hover:bg-white">Analytics</Link></nav>
