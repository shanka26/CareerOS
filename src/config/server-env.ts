...
const serverEnvSchema = z
  .object({
    ...
    JOOBLE_API_KEY: optionalCredential,
    REED_API_KEY: optionalCredential,
    CAREERJET_API_KEY: optionalCredential,
    CAREERJET_LOCALE_CODE: z.string().trim().regex(/^[a-z]{2}_[A-Z]{2}$/).default("en_US"),
